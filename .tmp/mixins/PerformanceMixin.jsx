...
function isNonImmutable(item) {
    return item && typeof item === 'object' && !isReactElement(item) && !isImmutable(item);
}

function warnNonImmutable(component, prop) {
    console.warn('Component ' + '"' + component.constructor.displayName + '"' + ' received non-immutable object for ' + '"' + prop + '"');
}
...
module.exports = {
    componentWillMount: function () {
        this.ignoreImmutableCheck = mergeDefaultValues(defaults.getIgnoreImmutableCheck(), {}, IGNORE_IMMUTABLE_CHECK, this);
