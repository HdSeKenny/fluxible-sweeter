...
module.exports = {
    ...
    _updateDeviceSize: function (e) {
        ...
        if (width >= 992) this.setState({ deviceSize: Sizes.LARGE, adjustSize: true });else if (width >= 768) this.setState({ deviceSize: Sizes.MEDIUM, adjustSize: true });else this.setState({ deviceSize: Sizes.SMALL, adjustSize: true }); // width >= 375
    },
