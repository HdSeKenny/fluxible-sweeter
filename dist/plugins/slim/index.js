 ...
 */
exports.default = typeof window !== 'undefined' ? function () {
  ...
  var Slim = function () {
    ...
    _createClass(Slim, [{
      ...
      value: function _storeServerResponse(data) {
        ...
        this._output.value = (typeof data === 'undefined' ? 'undefined' : _typeof(data)) === 'object' ? (0, _stringify2.default)(this._data.server) : data;
      }
      ...
      value: function _store(data) {
        ...
        this._output.value = (0, _stringify2.default)(data);
      }
  ...
  (function () {
    ...
    // the did callbacks
    ['Init', 'Load', 'Save', 'Upload', 'Remove', 'Transform', 'ReceiveServerError', 'Confirm'].forEach(function (cb) {
