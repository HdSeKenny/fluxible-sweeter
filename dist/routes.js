...
const createRoutes = context => {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_reactRouter.Route, { path: ':user/list', component: _components.UserBlogs }),
    _react2.default.createElement(_reactRouter.Route, { path: ':user/add', component: _components.AddBlog }),
    _react2.default.createElement(_reactRouter.Route, { path: ':user/info', component: _components.UserInfo }),
    _react2.default.createElement(_reactRouter.Route, { path: ':user/change-password', component: _components.ChangePassword }),
