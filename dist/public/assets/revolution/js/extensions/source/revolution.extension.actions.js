		...
		if (as) jQuery.each(as, function (i, a) {
			...
			_nc.on(a.event, function () {
				...
				if (a.action == "stoplayer" || a.action == "togglelayer" || a.action == "startlayer") {
					if (tnc.length > 0) if (a.action == "startlayer" || a.action == "togglelayer" && tnc.data('animdirection') != "in") {
						...
						if (_R.endMoveCaption) punchgs.TweenLite.delayedCall(a.delay, _R.endMoveCaption, [tnc, null, null, opt]);
