...
<html lang="en">
<head>
    <title>Code coverage report for express-dustjs/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">express-dustjs/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">express-dustjs/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (dustOptions.useHelpers) {
...
&nbsp;
    return function (file, options, callback) {
      var compiler
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (dustOptions.cache) {
        compiler = cache[file]
      }
&nbsp;
      var ext = '.' + (options.ext || dustOptions.ext)
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!_.isFunction(compiler)) {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sun Jun 28 2015 19:57:50 GMT+0800 (CST)</div>
</div>
