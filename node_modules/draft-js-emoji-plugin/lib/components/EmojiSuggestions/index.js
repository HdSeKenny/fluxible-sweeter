  ...
  _createClass(EmojiSuggestions, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          store = _props.store,
          restProps = _objectWithoutProperties(_props, ['theme', 'cacheBustParam', 'imagePath', 'imageType', 'ariaProps', 'callbacks', 'onClose', 'onOpen', 'onSearchChange', 'positionSuggestions', 'shortNames', 'store']);
